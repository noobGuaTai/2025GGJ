...
public class ContainerManIdleState : IState
{
    ContainerManFSM fsm;
    Coroutine patrol;
    public ContainerManIdleState(ContainerManFSM fsm) => this.fsm = fsm;

    public void OnEnter()
    {
        fsm.OnEnter(ContainerManStateType.Idle);
    ...
    IEnumerator Patrol()
    {
        ...
        fsm.ChangeState(ContainerManStateType.Patrol);
    }
}
